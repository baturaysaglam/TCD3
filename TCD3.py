...
# Implementation of the Triplet Critic Deep Deterministic Policy Gradient algorithm (TCD3)
# Paper: https://arxiv.org/abs/2109.10736
...
class TCD3(object):
    ...
    def update_parameters(self, replay_buffer, batch_size=256):
        ...
        with torch.no_grad():
            ...
            # Compute the target Q-value by the Triplet Critic Update
            target_Q1, target_Q2, target_Q3 = self.critic_target(next_state, next_action)
            target_Q = torch.min(torch.max(target_Q1, target_Q2), target_Q3)
